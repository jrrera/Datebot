...
angular.module('datebot').filter('replaceLineBreaks', function() {
...
angular.module('datebot').filter('unsafe', function($sce) {
    return function(val) {
...
angular.module('datebot').filter('adjustCapitalLetters', function() {
